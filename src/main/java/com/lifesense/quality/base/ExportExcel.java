...
public class ExportExcel<T> {
	...
	public void exportExcel(String title, String[] headers, String[] headersName, Collection<T> dataset,
			OutputStream out) {
	 ...
	 * 
	 * @param dataset
	 * 需要显示的数据集合，集合中一定要放置符合javabean风格的类的对象。此方法支持的javabean属性的数据类型有基本数据类型及String，Date，
	 * byte[]（图片数据)
	 * 
	...
	public void verify(Object value, HSSFCell cell, HSSFRow row, String pattern, HSSFSheet sheet, int index,
			HSSFPatriarch patriarch, HSSFWorkbook workbook, int i) {
		// 判断值的类型后进行强制类型转换
